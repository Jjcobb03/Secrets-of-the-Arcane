...
import net.jjcobb03.secretsofthearcane.item.custom.EssentiaVial;
...
public class ModItems {
    ...
    public static final DeferredItem<EssentiaVial> ESSENTIA_VIAL = ITEMS.register("essentia_vial",
            () -> new EssentiaVial(new Item.Properties()));
