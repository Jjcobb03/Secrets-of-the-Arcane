...
import net.jjcobb03.secretsofthearcane.worldgen.ModBiomeModifiers;
import net.jjcobb03.secretsofthearcane.worldgen.ModConfiguredFeatures;
import net.jjcobb03.secretsofthearcane.worldgen.ModPlacedFeatures;
...
public class ModDatapackProvider extends DatapackBuiltinEntriesProvider {
    ...
    public ModDatapackProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries, BUILDER, Set.of(SecretsOfTheArcane.MOD_ID));
    }
}
