package com.example.secretsofthearcane;
...
@Mod(value = SecretsoftheArcane.MODID, dist = Dist.CLIENT)
// You can use EventBusSubscriber to automatically register all static methods in the class annotated with @SubscribeEvent
@EventBusSubscriber(modid = SecretsoftheArcane.MODID, value = Dist.CLIENT)
